...
<br/>
Nginx server will be used to deploy React Application as a front-end and Gunicorn server will be used to deploy Python Flask Application as back-end. <br/><br/>PS : There is another alternative using AWS Amplify for hosting the front-end and a serverless computing service for the backend AWS Lambda, flask in this case which will be very benefical since we will not pay for resources except when they are used, but we will not see it in this demo
<br/>
<br/>
